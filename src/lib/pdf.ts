...
.slm-report-head{display:flex;align-items:center;justify-content:space-between;padding-bottom:12px;margin-bottom:18px;border-bottom:0.5px solid #E2E8F0;}
.slm-report-brand-wrap{display:flex;align-items:center;gap:8px;}
.slm-report-brand{font-weight:500;font-size:17px;letter-spacing:-.02em;color:#0F1117;}
.slm-report-brand-lm{color:#0EA5A0;}
.slm-report-meta{font-size:9.5pt;color:#64748B;font-weight:500;}
.slm-report-topic{margin:0 0 16px;font-size:14pt;font-weight:500;letter-spacing:-.02em;line-height:1.35;color:#0F1117;}
.slm-report-label{display:inline-flex;align-items:center;justify-content:center;min-width:28px;height:22px;padding:0 6px;font-family:'JetBrains Mono',monospace;font-weight:500;font-size:9pt;border-radius:6px;background:#0EA5A015;color:#0EA5A0;margin-right:8px;flex-shrink:0;}
.slm-report-q{display:flex;align-items:flex-start;margin-bottom:20px;padding:12px 14px;background:#F8F9FC;border:0.5px solid #E2E8F0;border-radius:10px;}
.slm-report-q-text{font-weight:500;font-size:11pt;line-height:1.45;}
.slm-report-a{display:flex;align-items:flex-start;}
.slm-report-a-body{flex:1;min-width:0;}
.slm-report-step{margin:0 0 16px;padding:12px 14px;border:0.5px solid #E2E8F0;border-radius:10px;page-break-inside:avoid;break-inside:avoid;background:#F8F9FC;}
.slm-report-step-title{font-size:11pt;font-weight:500;margin:0 0 8px;color:#0F1117;}
.slm-report-step-no{display:inline-flex;align-items:center;justify-content:center;min-width:22px;height:18px;margin-right:6px;padding:0 4px;font-family:'JetBrains Mono',monospace;font-size:8pt;font-weight:500;border-radius:6px;background:#0EA5A015;color:#0EA5A0;vertical-align:middle;}
.slm-report-formula{margin:6px 0 10px;padding:10px 12px;background:#F8F9FC;border:0.5px solid #E2E8F0;border-radius:6px;overflow-x:auto;font-family:'JetBrains Mono',monospace;font-size:10pt;color:#0EA5A0;}
.slm-report-formula-label{display:block;font-size:7.5pt;font-weight:500;letter-spacing:.04em;text-transform:uppercase;color:#64748B;margin-bottom:4px;}
...
.slm-report-takeaway{font-size:10pt;color:#64748B;border-left:2px solid #F59E0B;padding:8px 12px;margin:8px 0 0;background:#fff;border-radius:0 6px 6px 0;}
.slm-report-takeaway-label{display:block;font-size:7.5pt;font-weight:500;letter-spacing:.04em;text-transform:uppercase;color:#F59E0B;margin-bottom:3px;}
.slm-report-takeaway p{display:inline;margin:0;}
.slm-report-solution{margin-top:14px;padding:14px;border-top:0.5px solid #E2E8F0;}
.slm-report-solution-title{font-size:12pt;font-weight:500;margin:0 0 10px;color:#0EA5A0;}
