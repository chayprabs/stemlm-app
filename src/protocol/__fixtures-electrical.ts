...
export const SERIES_PARALLEL_CIRCUIT = [
  ...
  'a: Three nodes — A at $12\\,\\text{V}+$, B between $R_1=4\\,\\Omega$ and the parallel pair, and C at return — because every branch junction in this $12\\,\\text{V}$ network maps to one of these three points.',
  '@endquickcheck',
  '@followup',
  ...
  '@endformula',
  '@body',
  '$R_{\\parallel}$ is the equivalent resistance of branches in parallel, where $R_{\\parallel}=\\frac{R_2\\cdot R_3}{R_2+R_3}$. Here $R_2=10\\,\\Omega$ and $R_3=10\\,\\Omega$ share nodes B and C.',
  '@endbody',
  '@diagram type=svg',
  ...
  'a: $R_2$ and $R_3$ are in parallel because both terminals of each $10\\,\\Omega$ resistor connect to nodes B and C.',
  '@endquickcheck',
  '@followup',
  ...
  'a: $I=\\frac{V}{R_{\\text{total}}}=\\frac{12}{9}=\\frac{4}{3}\\,\\text{A}$, because Ohm\'s law gives source current through the $9\\,\\Omega$ total resistance.',
  '@endquickcheck',
  '@followup',
...
export const NODE_VOLTAGE_CIRCUIT = [
  ...
  'a: Two equations, because $N_1$ and $N_2$ are the only non-ground nodes and KCL gives one independent equation per unknown node voltage.',
  '@endquickcheck',
  '@followup',
  ...
  '@endformula',
  '@body',
  'Current into $N_1$ through $R_1$ equals current out through $R_2$. Multiplying $\\frac{12-V_1}{6}=\\frac{V_1-V_2}{3}$ by $6$ gives $12-V_1=2(V_1-V_2)$, so $3V_1-2V_2=12$.',
  '@endbody',
  '@diagram type=svg',
  NV_SVG_2_KCL_N1,
  '@enddiagram',
  ...
  '@endformula',
  '@body',
  'Current into $N_2$ arrives from $R_2$ and the $2\\,\\text{A}$ source. Multiplying $\\frac{V_1-V_2}{3}+2=\\frac{V_2}{4}$ by $12$ yields $4V_1-7V_2=-24$.',
  '@endbody',
  '@diagram type=svg',
  NV_SVG_3_KCL_N2,
  '@enddiagram',
  ...
  'a: No voltage term appears, because the $2\\,\\text{A}$ source enters KCL as $+2$ in $\\frac{V_1-V_2}{3}+2=\\frac{V_2}{4}$, not as a branch voltage.',
  '@endquickcheck',
  '@followup',
  ...
  'a: Gaussian elimination or a $3\\times3$ conductance matrix solve, because this $2\\times2$ system ($3V_1-2V_2=12$, $4V_1-7V_2=-24$) does not scale cleanly with Cramer\u2019s rule.',
  '@endquickcheck',
  '@followup',
  ...
  'a: Yes, because $V_{N1}=\\frac{132}{13}\\approx10.15\\,\\text{V} > V_{N2}=\\frac{120}{13}\\approx9.23\\,\\text{V}$, so current through $R_2=3\\,\\Omega$ flows from $N_1$ to $N_2$.',
  '@endquickcheck',
  '@followup',
  ...
  'a: Not always, because here the $2\\,\\text{A}$ source delivers $2\\times\\frac{120}{13}=\\frac{240}{13}\\,\\text{W}$ while the $12\\,\\text{V}$ source contributes $\\frac{48}{13}\\,\\text{W}$, totaling $\\frac{288}{13}\\,\\text{W}$ generated.',
  '@endquickcheck',
  '@followup',
