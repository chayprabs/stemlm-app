/**
 * End-to-end verification for physics question capsules:
...
import type { PhysicsQuestionDef } from './physics-question-bank/types';
...
export async function verifyPhysicsQuestion(def: PhysicsQuestionDef): Promise<PhysicsVerifyResult> {
  const errors: string[] = [];
  const warnings: string[] = [];
  const raw = buildPhysicsCapsule(def);
