/**
 * End-to-end verification for biology question capsules:
...
import type { BiologyQuestionDef } from './biology-question-bank/types';
import type { Session } from './types';

export interface BiologyVerifyResult {
  id: string;
  number: number;
  ok: boolean;
  errors: string[];
...
export async function verifyBiologyQuestion(def: BiologyQuestionDef): Promise<BiologyVerifyResult> {
  const errors: string[] = [];
