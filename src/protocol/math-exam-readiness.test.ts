/**
 * End-to-end readiness audit for all 50 math exam prompts:
 * question bank → classifier → Gemini injection → numeric oracle (test-only).
 */
...
describe('math exam readiness (50 questions)', () => {
  ...
  it('summary: all 50 questions pass readiness checks', () => {
