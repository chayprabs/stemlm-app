/**
 * End-to-end verification for mathematics question capsules:
 * parse, math accuracy patterns, SVG pipeline, label layout, sizing, PDF profile.
 */
...
import type { MathQuestionDef } from './math-question-bank/types';
...
export async function verifyMathQuestion(def: MathQuestionDef): Promise<MathVerifyResult> {
  const errors: string[] = [];
