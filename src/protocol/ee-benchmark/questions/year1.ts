...
export const Q03 = defineQuestion({
  ...
  steps: [
    ...
    { title: 'Solve for mesh currents', formula: '$$I_1=\\frac{190}{51}\\,\\text{A},\\; I_2=\\frac{10}{17}\\,\\text{A},\\; I_3=-\\frac{110}{153}\\,\\text{A}$$', body: 'Elimination yields $I_2=10/17\\,\\text{A}$, $I_1=190/51\\,\\text{A}$, $I_3=-110/153\\,\\text{A}$ (negative $I_3$ means opposite to assumed CW).', takeaway: 'Back-substitute into simplest equation.', quickcheckQ: 'Units of mesh currents?', quickcheckA: 'Amperes.', followup: 'Find power in each resistor.' },
    { title: 'Power delivered by each source', formula: '$$P_{20V}=20I_1\\approx74.5\\,\\text{W},\\quad P_{10V}=10|I_3|\\approx7.2\\,\\text{W}$$', body: 'The $20\\,\\text{V}$ source delivers $20I_1\\,\\text{W}$. The $10\\,\\text{V}$ source is opposed by $I_3<0$, so it absorbs power.', takeaway: '$P_{source}=V_s I_s$ when current leaves + terminal.', quickcheckQ: 'Can a source absorb power?', quickcheckA: 'Yes — here the $10\\,\\text{V}$ source absorbs $\\approx7.2\\,\\text{W}$.', followup: 'Verify with nodal analysis.' },
  ],
  solution: ['$I_1=190/51\\,\\text{A}$, $I_2=10/17\\,\\text{A}$, $I_3=-110/153\\,\\text{A}$.', 'Power: $P_{20V}=20I_1$, $P_{10V}=10I_3$ (negative — source absorbs).'],
});
